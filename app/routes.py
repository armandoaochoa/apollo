...
def add_security_headers(resp):
    resp.headers['Content-Security-Policy']="default-src 'self' 'unsafe-inline' data: gap: https://ssl.gstatic.com https://www.fileundernda.com www.fileundernda.com fileundernda.com; style-src 'self' 'unsafe-inline'; media-src *; script-src 'self' 'unsafe-inline' https://fileundernda.com https://www.fileundernda.com www.fileundernda.com fileundernda.com"
    return resp
